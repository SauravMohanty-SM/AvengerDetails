 ...
 * Use the {@link Appearance#newInstance} factory method to
...
public class Appearance extends Fragment {
    ...
    public static Appearance newInstance(String param1, String param2) {
        Appearance fragment = new Appearance();
